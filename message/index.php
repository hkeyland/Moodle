...
if (strpos($url, '=') !== false) {
	...
	echo '<script>
                $(document).ready(function(){
                        //alert("HOLAS");
                        $("#scontactosk").append( "<form action=\"index.php\" method=\"GET\"><fieldset><input type=\"hidden\" name=\"viewing\" value=\"search\"><input type=\"submit\" value=\"Buscar Contactos\" class=\"visible\"></fieldset></form>" );
                });
        </script>';
}
